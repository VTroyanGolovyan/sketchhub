  ...
  this.onmouseup  = function(coords){
     ...
     if(width > 0 && height > 0){
      ...
      if (t){
        ctx.moveTo(2*d,d);
        ctx.lineTo(2*d,d);
        ctx.lineTo(l.width-d,d);
        ctx.lineTo(Math.floor((l.width+0)/2),l.height-d);
        ctx.lineTo(2*d,d);
      }else{
        ctx.moveTo(2*d,l.height-d);
        ctx.lineTo(2*d,l.height-d);
        ctx.lineTo(l.width-d,l.height-d);
        ctx.lineTo(Math.floor((l.width+0)/2),2*d);
        ctx.lineTo(2*d,l.height-d);
      }
      ctx.stroke();
